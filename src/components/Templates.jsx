...
const demos = [
  {
    _id: "1",
    title: "E-Commerce website with easy management (dynamic)",
    img: img1,
  ...
  return (
    <section id="templates" className="container lg:pt-28 pt-24 text-center">
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
        {demos?.map((demo) => (
          <div key={demo?._id} className="border shadow h-96">
            {demo?.img ? (
              <>
            ...
            <div className="mt-3 flex justify-between h-[52px] bg-gradient-to-r from-rose-50 to-indigo-100">
              <p className="text-slate-700 text-left primary-color font-medium text-sm capitalize mb-3 pl-1">
                {demo?.title}
              </p>
              {demo?.url && (
