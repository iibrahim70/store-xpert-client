...
const ShortFeatures = () => {
  return (
    <div className="container drop-shadow-lg text-slate-950 lg:-mt-10 mt-16 grid text-center lg:grid-cols-3 grid-cols-1 gap-5">
      <div className="bg-orange-50 py-6 p-3 rounded-lg">
